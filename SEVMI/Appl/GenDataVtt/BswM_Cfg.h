...
/* -----------------------------------------------------------------------------
    &&&~ RULE DEFINES
 ----------------------------------------------------------------------------- */
#define BswMConf_BswMRule_BswMRule_CAN_FULL_COMM (0) 
...
#define BswMConf_BswMRule_ESH_RunToPostRun (10) 
#define BswMConf_BswMRule_ESH_RunToPostRunNested (11) 
#define BswMConf_BswMRule_ESH_WaitToShutdown (12) 
#define BswMConf_BswMRule_ESH_WakeupToPrep (14) 
#define BswMConf_BswMRule_ESH_WaitToWakeup (13) 
#define BswMConf_BswMRule_ESH_WakeupToRun (15) 
#define BswMConf_BswMRule_ESH_DemInit (4) 
#define BswMConf_BswMRule_ESH_InitToWakeup (5) 
#define BswMConf_BswMRule_ESH_PostRunToPrepNested (8) 
#define BswMConf_BswMRule_ESH_PostRunNested (7) 
#define BswMConf_BswMRule_ESH_PostRun (6) 
#define BswMConf_BswMRule_ESH_PrepToWait (9) 
...
typedef struct sBswM_ActionListQueueStructTag
{
  ...
  BswM_ActionListQueueType AL_BswMRule_CAN_FULL_COMM_BswMActionList_True[1];
  BswM_ActionListQueueType AL_BswMRule_CAN_FULL_COMM_BswMActionList_False[1];
...
extern FUNC(void, BSWM_CODE) Appl_StartCommunication(void);
