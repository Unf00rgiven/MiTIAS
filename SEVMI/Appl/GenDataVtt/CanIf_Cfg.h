...
#define CanIfTxPduHnd_msg_diag_Response_MyECU_Tp_oCAN00_Tx_3abd61be                                 0U
#define CanIfTxPduHnd_msg_nm_MyECU_oCAN00_Tx_3abd61be                                               1U
#define CanIfTxPduHnd_msg_MyECU_2_Rear_oCAN00_Tx_3abd61be                                           2U
...
#define CanIfRxPduHnd_msg_diag_RequestGlobal_Tp_oCAN00_Rx_3abd61be                                  0U
#define CanIfRxPduHnd_msg_diag_Request_MyECU_Tp_oCAN00_Rx_3abd61be                                  1U
/* Assigned to: PduR_CanIfRxIndication*/
#define CanIfRxPduHnd_msg_Rear_2_MyECU_oCAN00_Rx_3abd61be                                           0U
...
#define CanIfConf_CanIfTxPduCfg_msg_diag_Response_MyECU_Tp_oCAN00_Tx_3abd61be                       0U
#define CanIfConf_CanIfTxPduCfg_msg_nm_MyECU_oCAN00_Tx_3abd61be                                     1U
#define CanIfConf_CanIfTxPduCfg_msg_MyECU_2_Rear_oCAN00_Tx_3abd61be                                 2U
...
#define CanIfConf_CanIfRxPduCfg_msg_diag_RequestGlobal_Tp_oCAN00_Rx_3abd61be                        1U
#define CanIfConf_CanIfRxPduCfg_msg_diag_Request_MyECU_Tp_oCAN00_Rx_3abd61be                        2U
#define CanIfConf_CanIfRxPduCfg_msg_Rear_2_MyECU_oCAN00_Rx_3abd61be                                 3U
...
#define CanIf_GetSizeOfRxPduCanIdOfPCConfig()                         4UL  /**< the number of accomplishable value elements in CanIf_RxPduCanId */
#define CanIf_GetSizeOfRxPduConfigOfPCConfig()                        4UL  /**< the number of accomplishable value elements in CanIf_RxPduConfig */
#define CanIf_GetSizeOfRxPduMaskOfPCConfig()                          4UL  /**< the number of accomplishable value elements in CanIf_RxPduMask */
...
#define CanIf_GetSizeOfTxBufferPrioByCanIdByteQueueMappedTxPdusOfPCConfig() 3UL  /**< the number of accomplishable value elements in CanIf_TxBufferPrioByCanIdByteQueueMappedTxPdus */
...
#define CanIf_GetSizeOfTxPduQueueIndexOfPCConfig()                    3UL  /**< the number of accomplishable value elements in CanIf_TxPduQueueIndex */
#define CanIf_GetSizeOfTxQueueOfPCConfig()                            3UL  /**< the number of accomplishable value elements in CanIf_TxQueue */
...
{
  CanIf_TxPrioByCanIdByteQueueType msg_diag_Response_MyECU_Tp_oCAN00_Tx_3abd61be[1];
  CanIf_TxPrioByCanIdByteQueueType msg_nm_MyECU_oCAN00_Tx_3abd61be[1];
  CanIf_TxPrioByCanIdByteQueueType msg_MyECU_2_Rear_oCAN00_Tx_3abd61be[1];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  CanIf_TxPrioByCanIdByteQueueType raw[3];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(CanIf_RxPduCanIdType, CANIF_CONST) CanIf_RxPduCanId[4];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(CanIf_RxPduMaskType, CANIF_CONST) CanIf_RxPduMask[4];
#define CANIF_STOP_SEC_CONST_16BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(CanIf_TxBufferPrioByCanIdByteQueueMappedTxPdusType, CANIF_CONST) CanIf_TxBufferPrioByCanIdByteQueueMappedTxPdus[3];  /* PRQA S 0777 */  /* MD_MSR_5.1_777 */
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(CanIf_TxPduQueueIndexType, CANIF_CONST) CanIf_TxPduQueueIndex[3];
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
