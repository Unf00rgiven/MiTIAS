...
CONST(CanIf_MailBoxConfigType, CANIF_CONST) CanIf_MailBoxConfig[2] = {
  ...
  { /*     0 */           0UL  /* /ActiveEcuC/CanIf/CanIfCtrlDrvCfg/CT_CAN00_e98c47e6 */,         0U  /* Unused, TxPduId 0 */,        0U  /* Unused, TxPduId 2 */,                                    0UL  /* /ActiveEcuC/CanIf/CanIfInitCfg/CanIfBufferCfg_Tx_Std_0fb271d2 */, CANIF_TXBUFFER_HANDLINGTYPE_PRIOBYCANID, CANIF_TxBasicCANMailbox },  /* [/ActiveEcuC/Can/CanConfigSet/CN_CAN00_e98c47e6_Tx_Std] */
  { /*     1 */           0UL  /* /ActiveEcuC/CanIf/CanIfCtrlDrvCfg/CT_CAN00_e98c47e6 */,         1U  /* RxPduId */          ,        3U  /* RxPduId  */         , CANIF_NO_TXBUFFERCFGIDXOFMAILBOXCONFIG  /* unusedIndex1 */                                                 , CANIF_TXBUFFER_HANDLINGTYPE_NONE       , CANIF_RxBasicCANMailbox }   /* [/ActiveEcuC/Can/CanConfigSet/CN_CAN00_e98c47e6_Rx_Std] */
};
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
CONST(CanIf_RxPduCanIdType, CANIF_CONST) CanIf_RxPduCanId[4] = {
  /* Index    RxPduCanId                                                                           */
  /*     0 */    0x0400U  /* Lower CanId of range: MyECU_5faa4e95_NMCanIDRange, 2.0- or FD-PDU */,
  /*     1 */    0x0614U  /* msg_diag_RequestGlobal_Tp_oCAN00_Rx_3abd61be, 2.0- or FD-PDU */     ,
  /*     2 */    0x0610U  /* msg_diag_Request_MyECU_Tp_oCAN00_Rx_3abd61be, 2.0- or FD-PDU */     ,
  /*     3 */    0x0210U  /* msg_Rear_2_MyECU_oCAN00_Rx_3abd61be, 2.0- or FD-PDU */              
};
...
CONST(CanIf_RxPduConfigType, CANIF_CONST) CanIf_RxPduConfig[4] = {
  ...
  { /*     1 */ CanTpConf_CanTpRxNPdu_CanTpRxNPdu_f2ee9cdf                 ,  8U,                    2UL  /* CanTp_RxIndication */     },  /* [PDU: msg_diag_RequestGlobal_Tp_oCAN00_Rx_3abd61be, CanId: 0x614] */
  { /*     2 */ CanTpConf_CanTpRxNPdu_CanTpRxNPdu_f602b9fe                 ,  8U,                    2UL  /* CanTp_RxIndication */     },  /* [PDU: msg_diag_Request_MyECU_Tp_oCAN00_Rx_3abd61be, CanId: 0x610] */
  { /*     3 */ PduRConf_PduRSrcPdu_SRC_Can_PT_msg_Rear_2_MyECU_0fb271d2_In,  5U,                    3UL  /* PduR_CanIfRxIndication */ }   /* [PDU: msg_Rear_2_MyECU_oCAN00_Rx_3abd61be, CanId: 0x210] */
};
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
CONST(CanIf_RxPduMaskType, CANIF_CONST) CanIf_RxPduMask[4] = {
  /* Index    RxPduMask                                                           */
  /*     0 */   0x643FU  /* Upper CanId of range: MyECU_5faa4e95_NMCanIDRange */,
  /*     1 */   0x07FFU  /* msg_diag_RequestGlobal_Tp_oCAN00_Rx_3abd61be */     ,
  /*     2 */   0x07FFU  /* msg_diag_Request_MyECU_Tp_oCAN00_Rx_3abd61be */     ,
  /*     3 */   0x07FFU  /* msg_Rear_2_MyECU_oCAN00_Rx_3abd61be */              
};
#define CANIF_STOP_SEC_CONST_16BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
CONST(CanIf_TxBufferPrioByCanIdByteQueueConfigType, CANIF_CONST) CanIf_TxBufferPrioByCanIdByteQueueConfig[1] = {
  ...
  { /*     0 */                        0UL  /* /ActiveEcuC/CanIf/CanIfInitCfg/CanIfBufferCfg_Tx_Std_0fb271d2 */,                                            3UL  /* /ActiveEcuC/CanIf/CanIfInitCfg/CanIfBufferCfg_Tx_Std_0fb271d2 */,                                            3UL  /* /ActiveEcuC/CanIf/CanIfInitCfg/CanIfBufferCfg_Tx_Std_0fb271d2 */,                                              0UL  /* /ActiveEcuC/CanIf/CanIfInitCfg/CanIfBufferCfg_Tx_Std_0fb271d2 */ }   /* [/ActiveEcuC/CanIf/CanIfInitCfg/CanIfBufferCfg_Tx_Std_0fb271d2] */
};
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
CONST(CanIf_TxBufferPrioByCanIdByteQueueMappedTxPdusType, CANIF_CONST) CanIf_TxBufferPrioByCanIdByteQueueMappedTxPdus[3] = {
  ...
  { /*     0 */            0UL  /* /ActiveEcuC/CanIf/CanIfInitCfg/msg_diag_Response_MyECU_Tp_oCAN00_Tx_3abd61be */ },  /* [/ActiveEcuC/CanIf/CanIfInitCfg/CanIfBufferCfg_Tx_Std_0fb271d2] */
  { /*     1 */            1UL  /* /ActiveEcuC/CanIf/CanIfInitCfg/msg_nm_MyECU_oCAN00_Tx_3abd61be */               },  /* [/ActiveEcuC/CanIf/CanIfInitCfg/CanIfBufferCfg_Tx_Std_0fb271d2] */
  { /*     2 */            2UL  /* /ActiveEcuC/CanIf/CanIfInitCfg/msg_MyECU_2_Rear_oCAN00_Tx_3abd61be */           }   /* [/ActiveEcuC/CanIf/CanIfInitCfg/CanIfBufferCfg_Tx_Std_0fb271d2] */
};
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
CONST(CanIf_TxPduConfigType, CANIF_CONST) CanIf_TxPduConfig[3] = {
  ...
  { /*     0 */ 0x0612U, CanTpConf_CanTpTxFcNPdu_CanTpTxFcNPdu_f602b9fe               ,           0UL  /* /ActiveEcuC/CanIf/CanIfCtrlDrvCfg/CT_CAN00_e98c47e6 */,  8U,  0U,                      2UL  /* CanTp_TxConfirmation */ },  /* [PDU: msg_diag_Response_MyECU_Tp_oCAN00_Tx_3abd61be] */  /* [/ActiveEcuC/CanIf/CanIfInitCfg/msg_diag_Response_MyECU_Tp_oCAN00_Tx_3abd61be] */
  { /*     1 */ 0x0400U, CanNmConf_CanNmTxPdu_msg_nm_MyECU_oCAN00_3abd61be            ,           0UL  /* /ActiveEcuC/CanIf/CanIfCtrlDrvCfg/CT_CAN00_e98c47e6 */,  8U,  0U,                      1UL  /* CanNm_TxConfirmation */ },  /* [PDU: msg_nm_MyECU_oCAN00_Tx_3abd61be]               */  /* [/ActiveEcuC/CanIf/CanIfInitCfg/msg_nm_MyECU_oCAN00_Tx_3abd61be] */
  { /*     2 */ 0x0200U, PduRConf_PduRDestPdu_DST_Can_PT_msg_MyECU_2_Rear_0fb271d2_Out,           0UL  /* /ActiveEcuC/CanIf/CanIfCtrlDrvCfg/CT_CAN00_e98c47e6 */,  6U,  0U,                      0UL  /* NULL_PTR */             }   /* [PDU: msg_MyECU_2_Rear_oCAN00_Tx_3abd61be]           */  /* [/ActiveEcuC/CanIf/CanIfInitCfg/msg_MyECU_2_Rear_oCAN00_Tx_3abd61be] */
};
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
CONST(CanIf_TxPduQueueIndexType, CANIF_CONST) CanIf_TxPduQueueIndex[3] = {
  ...
  { /*     0 */        0UL  /* /ActiveEcuC/CanIf/CanIfInitCfg/msg_diag_Response_MyECU_Tp_oCAN00_Tx_3abd61be */ },  /* [msg_diag_Response_MyECU_Tp_oCAN00_Tx_3abd61be, BasicCAN TxPdu with Tx-buffer] */  /* [/ActiveEcuC/CanIf/CanIfInitCfg/msg_diag_Response_MyECU_Tp_oCAN00_Tx_3abd61be, /ActiveEcuC/CanIf/CanIfCtrlDrvCfg/CT_CAN00_e98c47e6] */
  { /*     1 */        1UL  /* /ActiveEcuC/CanIf/CanIfInitCfg/msg_nm_MyECU_oCAN00_Tx_3abd61be */               },  /* [msg_nm_MyECU_oCAN00_Tx_3abd61be, BasicCAN TxPdu with Tx-buffer]               */  /* [/ActiveEcuC/CanIf/CanIfInitCfg/msg_nm_MyECU_oCAN00_Tx_3abd61be, /ActiveEcuC/CanIf/CanIfCtrlDrvCfg/CT_CAN00_e98c47e6] */
  { /*     2 */        2UL  /* /ActiveEcuC/CanIf/CanIfInitCfg/msg_MyECU_2_Rear_oCAN00_Tx_3abd61be */           }   /* [msg_MyECU_2_Rear_oCAN00_Tx_3abd61be, BasicCAN TxPdu with Tx-buffer]           */  /* [/ActiveEcuC/CanIf/CanIfInitCfg/msg_MyECU_2_Rear_oCAN00_Tx_3abd61be, /ActiveEcuC/CanIf/CanIfCtrlDrvCfg/CT_CAN00_e98c47e6] */
};
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
VAR(uCanIf_TxQueueType, CANIF_VAR_NOINIT) CanIf_TxQueue;  /* PRQA S 0759 */  /* MD_CSL_18.4 */
  ...
  /*     2 */  /* [/ActiveEcuC/CanIf/CanIfInitCfg/msg_MyECU_2_Rear_oCAN00_Tx_3abd61be] */
