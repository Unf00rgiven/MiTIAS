 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: CanSM_Cfg.h
 *   Generation Time: 2024-02-06 21:44:30
...
#define CanSM_IsProdErrorDetectOfChannelConfig(Index)                 
...
#define CanSM_GetDemEventIdOfChannelConfig(Index)                     FALSE
...
#define CanSM_HasDemEventIdOfChannelConfig()                          (TRUE != FALSE)
...
#define CanSM_HasProdErrorDetectOfChannelConfig()                     
...
#define CANSM_DEMEVENTIDOFCHANNELCONFIG                               STD_ON
...
#define CANSM_PRODERRORDETECTOFCHANNELCONFIG                          STD_OFF  /**< Deactivateable: 'CanSM_ChannelConfig.ProdErrorDetect' Reason: 'the value of CanSM_ProdErrorDetectOfChannelConfig is always 'false' due to this, the array is deactivated.' */
...
#define CANSM_ISDEF_DEMEVENTIDOFCHANNELCONFIG                         STD_ON
...
#define CANSM_ISDEF_PRODERRORDETECTOFCHANNELCONFIG                    STD_OFF
...
#define CANSM_EQ2_DEMEVENTIDOFCHANNELCONFIG                           FALSE
...
#define CANSM_EQ2_PRODERRORDETECTOFCHANNELCONFIG                      
