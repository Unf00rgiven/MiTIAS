...
#define CANTP_CFG_GEN_MINOR_VERSION                                            0U 
...
#define CANTP_GENERATOR_COMPATIBILITY_VERSION                                  0x00040924UL                                                   /* Extended error detection capabilities */ 
...
/* -----------------------------------------------------------------------------
    &&&~ Rx Sdu Handle IDs
----------------------------------------------------------------------------- */
#define CanTpConf_CanTpRxNSdu_RxNSdu_80c7e927 0U 
#define CanTpConf_CanTpRxNSdu_RxNSdu_bd8e3c3d 1U 

 
/* -----------------------------------------------------------------------------
    &&&~ Tx Sdu Handle IDs
----------------------------------------------------------------------------- */
#define CanTpConf_CanTpTxNSdu_TxNSdu_6aef5f8e 0U 


/* -----------------------------------------------------------------------------
    &&&~ Rx Pdu IDs
 ----------------------------------------------------------------------------- */
#define CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_276b19be 0U 
#define CanTpConf_CanTpRxNPdu_CanTpRxNPdu_f602b9fe     0U 
#define CanTpConf_CanTpRxNPdu_CanTpRxNPdu_f2ee9cdf     1U 


/* -----------------------------------------------------------------------------
    &&&~ TxConfirmation Pdu IDs
 ----------------------------------------------------------------------------- */
#define CanTpConf_CanTpTxFcNPdu_CanTpTxFcNPdu_f602b9fe 0U 
#define CanTpConf_CanTpTxNPdu_CanTpTxNPdu_276b19be     0U 
...
#define CANTP_EQ2_BLOCKSIZEOFRXSDUCFG                                 8U
...
#define CANTP_EQ2_CANIFTXPDUIDOFTXSDUCFG                              CanIfConf_CanIfTxPduCfg_msg_diag_Response_MyECU_Tp_oCAN00_Tx_3abd61be
...
#define CANTP_EQ2_PDURTXSDUIDOFTXSDUCFG                               PduRConf_PduRDestPdu_DST_Can_PT_msg_diag_Response_MyECU_0fb271d2_Out
#define CANTP_EQ2_RXFCADDRESSOFTXSDUCFG                               255U
#define CANTP_EQ2_RXFCPDUIDOFTXSDUCFG                                 CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_276b19be
...
#define CANTP_EQ2_TXPDUCONFIRMATIONPDUIDOFTXSDUCFG                    CanTpConf_CanTpTxNPdu_CanTpTxNPdu_276b19be
...
#define CanTp_GetCompatibilityVersionOfPCConfig()                     264484UL
...
#define CanTp_GetBlockSizeOfRxSduCfg(Index)                           8U
...
#define CanTp_GetCanIfTxPduIdOfTxSduCfg(Index)                        CanIfConf_CanIfTxPduCfg_msg_diag_Response_MyECU_Tp_oCAN00_Tx_3abd61be
...
#define CanTp_GetPduRTxSduIdOfTxSduCfg(Index)                         PduRConf_PduRDestPdu_DST_Can_PT_msg_diag_Response_MyECU_0fb271d2_Out
#define CanTp_GetRxFcAddressOfTxSduCfg(Index)                         255U
#define CanTp_GetRxFcPduIdOfTxSduCfg(Index)                           CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_276b19be
#define CanTp_GetRxSduCfgIdxOfTxSduCfg(Index)                         1U  /**< the index of the 0:1 relation pointing to CanTp_RxSduCfg */
...
#define CanTp_GetTxPduConfirmationPduIdOfTxSduCfg(Index)              CanTpConf_CanTpTxNPdu_CanTpTxNPdu_276b19be
...
**********************************************************************************************************************/
#define CanTp_Cfg_GetAddressingTypeByRxPdu(RxPduId)                   ((CanTp_AddressingFormatType)(CanTp_GetAddressingFormatOfRxPduMap((RxPduId))))  /* returns: AddressingFormat of RxPduMap */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
...
#define CanTp_RxCfg_GetAddressingFormat(Index)                        ((CanTp_GetRxAddressingFormatOfRxSduCfg((Index))))  /* returns: RxAddressingFormat */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_RxCfg_GetBS(Index)                                      ((uint8)(CanTp_GetBlockSizeOfRxSduCfg((Index))))  /* returns: BlockSize */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_RxCfg_GetCanIfTxFcPduId(Index)                          ((PduIdType)(CanTp_GetCanIfTxFcPduIdOfRxSduCfg((Index))))  /* returns: CanIfTxFcPduId */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_RxCfg_GetCanType(Index)                                 ((CanTp_GetCanTypeOfRxSduCfg((Index))))  /* returns: CanType */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_RxCfg_GetChannelMode(Index)                             ((CanTp_GetChannelModeOfRxSduCfg((Index))))  /* returns: ChannelMode */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_RxCfg_GetMaxPayload(Index)                              ((uint8)(CanTp_GetRxMaxPayloadLengthOfRxSduCfg((Index))))  /* returns: RxMaxPayloadLength */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_RxCfg_GetNAr(Index)                                     ((uint16)(CanTp_GetNArOfRxSduCfg((Index))))  /* returns: NAr */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_RxCfg_GetNBr(Index)                                     ((uint16)(CanTp_GetNBrOfRxSduCfg((Index))))  /* returns: NBr */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_RxCfg_GetNCr(Index)                                     ((uint16)(CanTp_GetNCrOfRxSduCfg((Index))))  /* returns: NCr */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_RxCfg_GetPaddingActivation(Index)                       ((boolean)(CanTp_IsRxPaddingActivationOfRxSduCfg((Index))))  /* returns: RxPaddingActivation */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_RxCfg_GetPduRRxSduId(Index)                             ((PduIdType)(CanTp_GetPduRRxSduIdOfRxSduCfg((Index))))  /* returns: PduRRxSduId */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_RxCfg_GetRxAddress(Index)                               ((uint8)(CanTp_GetRxAddressOfRxSduCfg((Index))))  /* returns: RxAddress */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_RxCfg_GetRxPduId(Index)                                 ((PduIdType)(CanTp_GetRxPduIdOfRxSduCfg((Index))))  /* returns: RxPduId */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_RxCfg_GetSTmin(Index)                                   ((uint8)(CanTp_GetSTminOfRxSduCfg((Index))))  /* returns: STmin */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_RxCfg_GetSduHdlBySNV(SymbolNameValue)                   ((PduIdType)(CanTp_GetRxSduCfgIdxOfRxSduSnv2Hdl((SymbolNameValue))))  /* returns: RxSduHdl */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_RxCfg_GetTAType(Index)                                  ((CanTp_GetRxTaTypeOfRxSduCfg((Index))))  /* returns: RxTaType */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_RxCfg_GetTxFcAddress(Index)                             ((uint8)(CanTp_GetTxFcAddressOfRxSduCfg((Index))))  /* returns: TxFcAddress */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_RxCfg_GetTxFcConfPduId(Index)                           ((PduIdType)(CanTp_GetTxFcPduConfirmationPduIdOfRxSduCfg((Index))))  /* returns: TxFcPduConfirmationPduId */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_RxCfg_GetTxSduHdl(Index)                                ((PduIdType)(CanTp_GetTxSduCfgIdxOfRxSduCfg((Index))))  /* returns: TxSduHdl */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_RxCfg_GetWFTmax(Index)                                  ((uint16)(CanTp_GetRxWftMaxOfRxSduCfg((Index))))  /* returns: RxWftMax */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_TxCfg_GetAddressingFormat(Index)                        ((CanTp_GetTxAddressingFormatOfTxSduCfg((Index))))  /* returns: TxAddressingFormat */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_TxCfg_GetCanIfTxPduId(Index)                            ((PduIdType)(CanTp_GetCanIfTxPduIdOfTxSduCfg((Index))))  /* returns: CanIfTxPduId */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_TxCfg_GetCanType(Index)                                 ((CanTp_GetCanTypeOfTxSduCfg((Index))))  /* returns: CanType */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_TxCfg_GetChannelMode(Index)                             ((CanTp_GetChannelModeOfTxSduCfg((Index))))  /* returns: ChannelMode */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_TxCfg_GetMaxPayload(Index)                              ((uint8)(CanTp_GetTxMaxPayloadLengthOfTxSduCfg((Index))))  /* returns: TxMaxPayloadLength */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_TxCfg_GetNAs(Index)                                     ((uint16)(CanTp_GetNAsOfTxSduCfg((Index))))  /* returns: NAs */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_TxCfg_GetNBs(Index)                                     ((uint16)(CanTp_GetNBsOfTxSduCfg((Index))))  /* returns: NBs */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_TxCfg_GetNCs(Index)                                     ((uint16)(CanTp_GetNCsOfTxSduCfg((Index))))  /* returns: NCs */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_TxCfg_GetPaddingActivation(Index)                       ((boolean)(CanTp_IsTxPaddingActivationOfTxSduCfg((Index))))  /* returns: TxPaddingActivation */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_TxCfg_GetPduRTxSduId(Index)                             ((PduIdType)(CanTp_GetPduRTxSduIdOfTxSduCfg((Index))))  /* returns: PduRTxSduId */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_TxCfg_GetRxFcAddress(Index)                             ((uint8)(CanTp_GetRxFcAddressOfTxSduCfg((Index))))  /* returns: RxFcAddress */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_TxCfg_GetRxFcPduId(Index)                               ((PduIdType)(CanTp_GetRxFcPduIdOfTxSduCfg((Index))))  /* returns: RxFcPduId */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_TxCfg_GetRxSduHdl(Index)                                ((PduIdType)(CanTp_GetRxSduCfgIdxOfTxSduCfg((Index))))  /* returns: RxSduHdl */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_TxCfg_GetSduHdlBySNV(SymbolNameValue)                   ((PduIdType)(CanTp_GetTxSduCfgIdxOfTxSduSnv2Hdl((SymbolNameValue))))  /* returns: TxSduHdl */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_TxCfg_GetTAType(Index)                                  ((CanTp_GetTxTaTypeOfTxSduCfg((Index))))  /* returns: TxTaType */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_TxCfg_GetTxAddress(Index)                               ((uint8)(CanTp_GetTxAddressOfTxSduCfg((Index))))  /* returns: TxAddress */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_TxCfg_GetTxCancel(Index)                                ((boolean)(CanTp_IsTransmitCancellationOfTxSduCfg((Index))))  /* returns: TransmitCancellation */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
#define CanTp_TxCfg_GetTxConfPduId(Index)                             ((PduIdType)(CanTp_GetTxPduConfirmationPduIdOfTxSduCfg((Index))))  /* returns: TxNPduConfirmationPduId */ /* PRQA S 3453 */ /* MD_MSR_19.7 */ 
