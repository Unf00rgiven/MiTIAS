...
CONST(ComM_UserByteMaskType, COMM_CONST) ComM_UserByteMask[1] = {
  ...
  { /*     0 */      0U,     0xFEU,   0x01U,                0U }   /* [/ActiveEcuC/ComM/ComMConfigSet/USR_CHNL_CAN00] */
};
#define COMM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
CONST(ComM_StateNotiFuncPtrType, COMM_CONST) ComM_UserModeNotiFunc[2] = {
  ...
  /*     0 */Rte_Switch_UM_USR_CHNL_CAN00_currentMode ,  /* [/ActiveEcuC/ComM/ComMConfigSet/USR_CHNL_CAN00] */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
VAR(ComM_FullComRequestersType, COMM_VAR_NOINIT) ComM_FullComRequesters[2];
