...
#define ComM_GetSizeOfFullComRequestersOfPCConfig()                   2U  /**< the number of accomplishable value elements in ComM_FullComRequesters */
#define ComM_GetSizeOfUserByteMaskOfPCConfig()                        1U  /**< the number of accomplishable value elements in ComM_UserByteMask */
#define ComM_GetSizeOfUserModeNotiFuncOfPCConfig()                    2U  /**< the number of accomplishable value elements in ComM_UserModeNotiFunc */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(ComM_StateNotiFuncPtrType, COMM_CONST) ComM_UserModeNotiFunc[2];
#define COMM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern VAR(ComM_FullComRequestersType, COMM_VAR_NOINIT) ComM_FullComRequesters[2];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern VAR(ComM_ModeType, COMM_VAR_NOINIT) ComM_LastStateChange[2];
#define COMM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
