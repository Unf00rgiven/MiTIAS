 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Com_Cfg.h
 *   Generation Time: 2024-02-10 19:33:42
...
#define COM_EQ2_PDUIDOFRXACCESSINFO                                   ComConf_ComIPdu_msg_Rear_2_MyECU_oCAN00_In
...
#define COM_EQ2_RXACCESSINFOINDENDIDXOFRXPDUINFO                      6U
#define COM_EQ2_RXACCESSINFOINDSTARTIDXOFRXPDUINFO                    0U
#define COM_EQ2_RXACCESSINFOINDUSEDOFRXPDUINFO                        TRUE
#define COM_EQ2_RXDEFPDUBUFFERENDIDXOFRXPDUINFO                       5U
#define COM_EQ2_RXDEFPDUBUFFERLENGTHOFRXPDUINFO                       5U
...
#define COM_EQ2_RXSIGINFOENDIDXOFRXPDUINFO                            6U
...
#define COM_EQ2_EXTERNALIDOFTXPDUINFO                                 PduRConf_PduRSrcPdu_SRC_Can_PT_msg_MyECU_2_Rear_0fb271d2_Out
...
#define COM_EQ2_PDUWITHMETADATALENGTHOFTXPDUINFO                      6U
#define COM_EQ2_TXPDUBUFFERENDIDXOFTXPDUINFO                          6U
#define COM_EQ2_TXPDUBUFFERLENGTHOFTXPDUINFO                          6U
...
#define COM_EQ2_TXPDUINITVALUEENDIDXOFTXPDUINFO                       6U
...
#define COM_EQ2_APPLTYPEOFTXSIGINFO                                   COM_UINT16_APPLTYPEOFTXSIGINFO
#define COM_EQ2_BITLENGTHOFTXSIGINFO                                  8U
#define COM_EQ2_BITPOSITIONOFTXSIGINFO                                
#define COM_EQ2_BUSACCOFTXSIGINFO                                     COM_BYTE_BUSACCOFTXSIGINFO
#define COM_EQ2_BYTELENGTHOFTXSIGINFO                                 1U
...
#define COM_EQ2_PDUIDOFTXSIGINFO                                      ComConf_ComIPdu_msg_MyECU_2_Rear_oCAN00_Out
...
#define ComConf_ComSignal_sig_BatteryModeSwitch_In                  0
#define ComConf_ComSignal_sig_CurrentSpeedSlider_In                 1
#define ComConf_ComSignal_sig_Ignition_In                           2
#define ComConf_ComSignal_sig_Locking_In                            3
#define ComConf_ComSignal_sig_SolarPanelSwitch_In                   4
#define ComConf_ComSignal_sig_SunlightPresence_In                   5
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComSignal_sig_BatteryStatus_Out                     0
#define ComConf_ComSignal_sig_SpeedLimit_Out                        1
/**\} */
...
/** 
  ...
  \{
*/ 
#define Com_GetAllSigCntOfPCConfig()                                  8UL
...
#define Com_GetSizeOfConstValueXInt16OfPCConfig()                     1U  /**< the number of accomplishable value elements in Com_ConstValueXInt16 */
...
#define Com_GetSizeOfRxDefPduBufferOfPCConfig()                       5U  /**< the number of accomplishable value elements in Com_RxDefPduBuffer */
...
#define Com_GetSizeOfRxSigBufferXInt16OfPCConfig()                    2U  /**< the number of accomplishable value elements in Com_RxSigBufferXInt16 */
#define Com_GetSizeOfRxSigBufferXInt8OfPCConfig()                     4U  /**< the number of accomplishable value elements in Com_RxSigBufferXInt8 */
...
#define Com_GetSizeOfTxPduBufferOfPCConfig()                          6U  /**< the number of accomplishable value elements in Com_TxPduBuffer */
...
#define Com_GetSizeOfTxPduInitValueOfPCConfig()                       6U  /**< the number of accomplishable value elements in Com_TxPduInitValue */
...
#define Com_GetBusAccOfRxAccessInfo(Index)                            Com_GetByteLengthOfRxAccessInfo(Index)  /**< BUS access algorithm for signal or group signal packing / un-packing. ea:{{63C9F63A-D1F5-474c-A7B2-BD00E0CE2BF0}} */
#define Com_GetBytePositionOfRxAccessInfo(Index)                      Com_GetStartByteInPduPositionOfRxAccessInfo(Index)  /**< Byte position of the signal or group signal within the I-PDU. ea:{{180FD2F9-6CDB-48e4-9557-FD4DFCABF773}} */
...
#define Com_GetPduIdOfRxAccessInfo(Index)                             ComConf_ComIPdu_msg_Rear_2_MyECU_oCAN00_In  /**< ID of the corresponding Rx I-PDU. ea:{{A28B90E1-F27A-48c1-9EB3-0EAEB574C2D5}} */
...
#define Com_GetRxAccessInfoIndEndIdxOfRxPduInfo(Index)                6U  /**< the end index of the 0:n relation pointing to Com_RxAccessInfoInd */
...
#define Com_GetRxDefPduBufferEndIdxOfRxPduInfo(Index)                 5U  /**< the end index of the 0:n relation pointing to Com_RxDefPduBuffer */
#define Com_GetRxDefPduBufferLengthOfRxPduInfo(Index)                 5U  /**< the number of relations pointing to Com_RxDefPduBuffer */
...
#define Com_GetRxSigInfoEndIdxOfRxPduInfo(Index)                      6U  /**< the end index of the 0:n relation pointing to Com_RxSigInfo */
...
#define Com_GetExternalIdOfTxPduInfo(Index)                           PduRConf_PduRSrcPdu_SRC_Can_PT_msg_MyECU_2_Rear_0fb271d2_Out  /**< External ID used to call PduR_ComTransmit(). ea:{{2181D34E-EC05-425f-A841-874F4C346BB5}} */
...
#define Com_GetPduWithMetaDataLengthOfTxPduInfo(Index)                6U  /**< Length of Pdu with MetaData. */
#define Com_GetTxPduBufferEndIdxOfTxPduInfo(Index)                    6U  /**< the end index of the 0:n relation pointing to Com_TxPduBuffer */
#define Com_GetTxPduBufferLengthOfTxPduInfo(Index)                    6U  /**< the number of relations pointing to Com_TxPduBuffer */
...
#define Com_GetTxPduInitValueEndIdxOfTxPduInfo(Index)                 6U  /**< the end index of the 0:n relation pointing to Com_TxPduInitValue */
...
#define Com_GetApplTypeOfTxSigInfo(Index)                             COM_UINT16_APPLTYPEOFTXSIGINFO  /**< Application data type. ea:{{E33B4863-9456-4cd2-84A1-94C89AF37A23}} */
#define Com_GetBitLengthOfTxSigInfo(Index)                            8U  /**< Bit length of the signal or group signal. ea:{{646B1706-21D2-4b10-A5AC-A1113F297CD1}} */
#define Com_GetBusAccOfTxSigInfo(Index)                               COM_BYTE_BUSACCOFTXSIGINFO  /**< BUS access algorithm for signal or group signal packing / un-packing. ea:{{63C9F63A-D1F5-474c-A7B2-BD00E0CE2BF0}} */
#define Com_GetByteLengthOfTxSigInfo(Index)                           1U  /**< Byte length of the signal or group signal. ea:{{646B1706-21D2-4b10-A5AC-A1113F297CD1}} */
#define Com_GetBytePositionOfTxSigInfo(Index)                         Com_GetStartByteInPduPositionOfTxSigInfo(Index)  /**< Byte position of the signal or group signal within the I-PDU. ea:{{180FD2F9-6CDB-48e4-9557-FD4DFCABF773}} */
#define Com_GetPduIdOfTxSigInfo(Index)                                ComConf_ComIPdu_msg_MyECU_2_Rear_oCAN00_Out  /**< ID of the corresponding Rx I-PDU. ea:{{A28B90E1-F27A-48c1-9EB3-0EAEB574C2D5}} */
/** 
  \}
*/ 
...
/** 
  ...
  \{
*/ 
/**   \brief  type used to iterate Com_ConstValueXInt16 */
typedef uint8_least Com_ConstValueXInt16IterType;
...
/**   \brief  type used to iterate Com_RxSigBufferXInt16 */
typedef uint8_least Com_RxSigBufferXInt16IterType;
...
/**   \brief  value based type definition for Com_ConstValueXInt16 */
...
/**   \brief  value based type definition for Com_RxSigBufferXInt16 */
...
/**   \brief  value based type definition for Com_SizeOfConstValueXInt16 */
...
/**   \brief  value based type definition for Com_SizeOfRxSigBufferXInt16 */
...
{
  Com_CurrentTxModeType msg_MyECU_2_Rear_oCAN00_Out[1];
...
{
  Com_CycleTimeCntType msg_MyECU_2_Rear_oCAN00_Out[1];
...
{
  Com_CyclicSendRequestType msg_MyECU_2_Rear_oCAN00_Out[1];
...
{
  Com_DelayTimeCntType msg_MyECU_2_Rear_oCAN00_Out[1];
...
{
  Com_HandleRxPduDeferredType msg_Rear_2_MyECU_oCAN00_In[1];
...
{
  Com_RepCntType msg_MyECU_2_Rear_oCAN00_Out[1];
...
{
  Com_RepCycleCntType msg_MyECU_2_Rear_oCAN00_Out[1];
...
{
  Com_RxDefPduBufferType msg_Rear_2_MyECU_oCAN00_In[5];
...
{
  Com_RxSigBufferXInt16Type sig_CurrentSpeedSlider_In[1];
  Com_RxSigBufferXInt16Type sig_SunlightPresence_In[1];
...
{
  Com_RxSigBufferXInt8Type sig_BatteryModeSwitch_In[1];
  Com_RxSigBufferXInt8Type sig_Ignition_In[1];
  Com_RxSigBufferXInt8Type sig_Locking_In[1];
  Com_RxSigBufferXInt8Type sig_SolarPanelSwitch_In[1];
...
{
  Com_TransmitRequestType msg_MyECU_2_Rear_oCAN00_Out[1];
...
{
  Com_TxPduBufferType msg_MyECU_2_Rear_oCAN00_Out[6];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  Com_RxDefPduBufferType raw[5];
  sCom_RxDefPduBufferStructType str;
} uCom_RxDefPduBufferType;

/**   \brief  type to access Com_RxSigBufferXInt16 in an index and symbol based style. */
typedef union uCom_RxSigBufferXInt16Tag
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  Com_RxSigBufferXInt16Type raw[2];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  Com_RxSigBufferXInt8Type raw[4];
...
/*lint -restore */
extern CONST(Com_ConstValueXInt16Type, COM_CONST) Com_ConstValueXInt16[1];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(Com_TxPduInitValueType, COM_CONST) Com_TxPduInitValue[6];
#define COM_STOP_SEC_CONST_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
