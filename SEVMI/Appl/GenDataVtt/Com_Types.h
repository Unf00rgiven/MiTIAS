...
typedef P2FUNC(void, COM_APPL_CODE, ComCbkInvType) (void);
...
typedef P2FUNC(void, COM_APPL_CODE, ComCbkRxAckType) (void);
typedef P2FUNC(boolean, COM_APPL_CODE, ComTxPduCalloutType) (PduIdType Id, P2VAR(uint8, AUTOMATIC, COM_APPL_DATA) IpduData);
typedef P2FUNC(boolean, COM_APPL_CODE, ComRxPduCalloutType) (PduIdType Id, P2CONST(uint8, AUTOMATIC, COM_APPL_DATA) IpduData);
