 ...
 *
 *   Description:  Application header file for SW-C <CtSaBatteryModeManager>
 *********************************************************************************************************************/
...
#  define Rte_Switch_CtSaBatteryModeManager_PpBswMBatteryLevel_BswM_MDGP_MdgBswMBatteryModes(mode) (RTE_E_OK) /* PRQA S 3453 */ /* MD_MSR_19.7 */


/**********************************************************************************************************************
 * Rte_Call_<p>_<o> (unmapped) for synchronous C/S communication
 *********************************************************************************************************************/
#  define Rte_Call_PpBatteryModeIn_ReadChannel(arg1) (RTE_E_UNCONNECTED) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
FUNC(void, CtSaBatteryModeManager_CODE) RCtApBatteryManager(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
