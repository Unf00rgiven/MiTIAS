 ...
 *
 *   Description:  Application header file for SW-C <CtSaSolarPanelControl>
 *********************************************************************************************************************/
...
#  define Rte_Read_CtSaSolarPanelControl_PpChargingIn_DeCharging(data) ((void)Com_ReceiveSignal(ComConf_ComSignal_sig_SolarPanelSwitch_In, (data)), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Write_CtSaSolarPanelControl_PpCharging_DeCharging(data) (Rte_CpSaSolarPanelControl_PpCharging_DeCharging = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
FUNC(void, CtSaSolarPanelControl_CODE) RCharging(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
