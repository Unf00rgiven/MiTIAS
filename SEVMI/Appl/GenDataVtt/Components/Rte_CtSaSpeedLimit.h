 ...
 *
 *   Description:  Application header file for SW-C <CtSaSpeedLimit>
 *********************************************************************************************************************/
...
extern VAR(IdtSpeedLimit, RTE_VAR_NOINIT) Rte_CpApSEVMIController_PpSpeedLimit_DeSpeedLimit; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
#  define Rte_Read_CtSaSpeedLimit_PpSpeedLimit_DeSpeedLimit(data) (*(data) = Rte_CpApSEVMIController_PpSpeedLimit_DeSpeedLimit, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
FUNC(void, CtSaSpeedLimit_CODE) RSpeedLimit(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
