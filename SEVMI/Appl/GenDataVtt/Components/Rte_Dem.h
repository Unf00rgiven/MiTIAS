...
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_Dem_CBReadData_BatteryValue_BatteryValue_ReadData(P2VAR(uint8, AUTOMATIC, RTE_DEM_APPL_VAR) Data); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
# else
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_Dem_CBReadData_BatteryValue_BatteryValue_ReadData(P2VAR(DataArray_Type_4, AUTOMATIC, RTE_DEM_APPL_VAR) Data); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
# endif
# ifdef RTE_PTR2ARRAYBASETYPE_PASSING
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_Dem_CBReadData_OccurrenceCounter_OccurenceCounter_ReadData(P2VAR(uint8, AUTOMATIC, RTE_DEM_APPL_VAR) Data); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
# else
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_Dem_CBReadData_OccurrenceCounter_OccurenceCounter_ReadData(P2VAR(DataArray_Type_4, AUTOMATIC, RTE_DEM_APPL_VAR) Data); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
# endif
 ...
 *********************************************************************************************************************/
#  define Rte_Call_CBReadData_BatteryValue_BatteryValue_ReadData Rte_Call_Dem_CBReadData_BatteryValue_BatteryValue_ReadData
#  define Rte_Call_CBReadData_OccurrenceCounter_OccurenceCounter_ReadData Rte_Call_Dem_CBReadData_OccurrenceCounter_OccurenceCounter_ReadData
