...
{
   {    1u,   0u,0x03u} /* DID: 0x0001 */
  ,{    4u,   2u,0x01u} /* DID: 0x1000 */
};
CONST(Dcm_CfgDidMgrOpInfoType, DCM_CONST) Dcm_CfgDidMgrOpInfo[3]=
{
   {    0u,   0u,0x05u} /* DID: 0x0001 */
  ,{    0u,   2u,0x01u} /* DID: 0x0001 */
  ,{    0u,   3u,0x05u} /* DID: 0x1000 */
};
CONST(Dcm_CfgDidMgrSignalOpClassInfoType, DCM_CONST) Dcm_CfgDidMgrSignalOpClassInfo[5]=
{
   { ((Dcm_DidMgrOpFuncType)(Rte_Call_DataServices_Diag_RWDI_PassingLane_PassingLane_PassingLane_ReadData)), 2u} /* DID: 0x0001 */                   /* PRQA S 0313 */ /* MD_Dcm_0313 */
  ,{ ((Dcm_DidMgrOpFuncType)(Rte_Call_DataServices_Diag_RWDI_PassingLane_PassingLane_PassingLane_ConditionCheckRead)), 1u} /* DID: 0x0001 */         /* PRQA S 0313 */ /* MD_Dcm_0313 */
  ,{ ((Dcm_DidMgrOpFuncType)(Rte_Call_DataServices_Diag_RWDI_PassingLane_PassingLane_PassingLane_WriteData)), 2u} /* DID: 0x0001 */                  /* PRQA S 0313 */ /* MD_Dcm_0313 */
  ,{ ((Dcm_DidMgrOpFuncType)(Rte_Call_DataServices_Diag_RDI_BatteryValue_BatteryValue_ReadData)), 2u} /* DID: 0x1000 */                              /* PRQA S 0313 */ /* MD_Dcm_0313 */
  ,{ ((Dcm_DidMgrOpFuncType)(Rte_Call_DataServices_Diag_RDI_BatteryValue_BatteryValue_ConditionCheckRead)), 1u} /* DID: 0x1000 */                    /* PRQA S 0313 */ /* MD_Dcm_0313 */
};
