...
/* Config Core Feature Version                                        5.0.0 */
/* Generator Internal Version                                         7.00.01 (Cfg5.11.x compatible, Release AR4-14), Revision: 77079, Variant: Vector */
...
#define DEM_CFG_SAFE_BSW_MODE                                         STD_OFF      /* Autodetected - STD_ON: /Dem/DemGeneral/DemSafeBswModeEnabled == TRUE && /EcuC/EcucGeneral/EcuCSafeBswChecks == TRUE (or undefined), STD_OFF: DemSafeBswModeEnabled == FALSE (or unset) || EcuCSafeBswChecks == FALSE */ 
...
#define DEM_CFG_SUPPORT_CYCLE_POWER                                   STD_ON       /* Autodetected - STD_ON: cycle type is referenced by any *CycleRef or the /Dem/DemGeneral/DemRestartCycleOnInitRef parameter, STD_OFF: cycle type is not referenced. The '*CycleRef' params are (here 11 refs): /Dem/DemConfigSet/DemEventParameter/DemEventClass/DemAgingCycleRef, ~/DemEventFailureCycleRef, ~/DemOperationCycleRef, ~/DemIndicatorAttribute/DemIndicatorFailureCycleRef and ~/DemIndicatorAttribute/DemIndicatorHealingCycleRef. */ 
...
#define DEM_CFG_SUPPORT_TIME_SERIES_FUTURE_FAST                       STD_OFF      /* Autodetected - STD_ON: (DemGeneral/DemMaxNumberTimeSeriesSnapshots > 0) && (DemGeneral/DemTimeSeriesSnapshot/DemTimeSeriesFastRateFutureSamples > 0) && (PostBuild-Loadable || any event has DemEventTimeSeries==FAST_RATE), STD_OFF: else. */ 
#define DEM_CFG_SUPPORT_TIME_SERIES_FUTURE_NORMAL                     STD_OFF      /* Autodetected - STD_ON: (DemGeneral/DemMaxNumberTimeSeriesSnapshots > 0) && (DemGeneral/DemTimeSeriesSnapshot/DemTimeSeriesNormalRateFutureSamples > 0) && (PostBuild-Loadable || any event has DemEventTimeSeries==NORMAL_RATE|FAST_RATE), STD_OFF: else. */ 
#define DEM_CFG_SUPPORT_TIME_SERIES_PAST_FAST                         STD_OFF      /* Autodetected - STD_ON: (DemGeneral/DemMaxNumberTimeSeriesSnapshots > 0) && (DemGeneral/DemTimeSeriesSnapshot/DemTimeSeriesFastRatePastSamples > 0) && (PostBuild-Loadable || any event has DemEventTimeSeries==FAST_RATE), STD_OFF: else. */ 
#define DEM_CFG_SUPPORT_TIME_SERIES_PAST_NORMAL                       STD_OFF      /* Autodetected - STD_ON: (DemGeneral/DemMaxNumberTimeSeriesSnapshots > 0) && (DemGeneral/DemTimeSeriesSnapshot/DemTimeSeriesNormalRatePastSamples > 0) && (PostBuild-Loadable || any event has DemEventTimeSeries==NORMAL_RATE|FAST_RATE), STD_OFF: else. */ 
...
#define DEM_CFG_SUPPORT_USER_ERECS                                    STD_ON       /* Internal - STD_ON: require generic buffer ExtendedData[], STD_OFF: all configured DemDataElementClass of DemExtendedDataRecordClass have individual buffers in Dem_Cfg_PrimaryEntryType */ 
...
#endif  /* DEM_CFG_H */
/**********************************************************************************************************************
  END OF FILE: Dem_Cfg.h     [Vector, VARIANT-PRE-COMPILE]
**********************************************************************************************************************/
