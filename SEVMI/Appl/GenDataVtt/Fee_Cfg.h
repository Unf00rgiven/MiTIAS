...
#define FeeConf_FeeBlockConfiguration_FeeCpApMySwcSnNvMPimLightOnOffCounter (208UL) 
#define FeeConf_FeeBlockConfiguration_FeeCpApMySwcSnNvM_PimOdometer (192UL) 
#define FeeConf_FeeBlockConfiguration_FeeCpApSEVMIControllerSnNvMPimDoorLock (224UL) 
