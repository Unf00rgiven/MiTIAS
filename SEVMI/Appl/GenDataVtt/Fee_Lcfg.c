...
static CONST(struct Fee_BlockConfigStruct, FEE_APPL_CONFIG) Fee_BlockConfig_at[] =
{
  ...
  { /*  Block: FeeCpApMySwcSnNvM_PimOdometer  */ 
  ...
  { /*  Block: FeeCpApMySwcSnNvMPimLightOnOffCounter  */ 
  ...
  { /*  Block: FeeCpApSEVMIControllerSnNvMPimDoorLock  */ 
...
{
  {
    ...
    {
      14648UL /*  FSS threshold  */ , 
      13624UL /*  BSS threshold  */ 
    }, 
