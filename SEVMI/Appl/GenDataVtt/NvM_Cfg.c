 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: NvM_Cfg.c
 *   Generation Time: 2024-02-09 00:01:45
...
NVM_SELECT_BLOCK_FOR_WRITEALL_ON
      ...
      { /*  CpApSEVMIControllerSnNvMPimDoorLock  */ 
        (NvM_RamAddressType)&Rte_CpApSEVMIController_SnNvMPimDoorLock_MirrorBlock /*  pointer to the RAM data buffer  */ , 
        NULL_PTR /*  pointer to the ROM buffer  */ , 
        NULL_PTR /*  pointer to the Init Callback function  */ , 
        Rte_Call_NvM_RpNotifyJobEnd_CpApSEVMIControllerSnNvMPimDoorLock_JobFinished /*  pointer to the job End Callback function  */ , 
        NULL_PTR /*  pointer to the ReadRamBlockFromNvCallback  */ , 
        NULL_PTR /*  pointer to the WriteRamBlockToNvCallback  */ , 
        NULL_PTR /*  pointer to the CRC data buffer  */ , 
...
struct PermanentRamBlockLengthChecks {
  ...
  NvM_LengthCheck Block_CpApSEVMIControllerSnNvMPimDoorLock : SizeOfRamBlockDoesNotMatchConfiguredLength(Rte_CpApSEVMIController_SnNvMPimDoorLock_MirrorBlock, 0, 1U);
