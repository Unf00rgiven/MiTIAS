...
#define PDUR_FCT_DCMTX 0x99U 
 /*   PduR_ComTransmit  PduR_CanIfIfRxIndication  PduR_CanIfTransmit  PduR_CanIfTxConfirmation  PduR_CanTpTpRxIndication  PduR_CanTpTransmit  PduR_CanTpTxConfirmation  PduR_CanTpStartOfReception  PduR_CanTpCopyRxData  PduR_CanTpCopyTxData  PduR_DcmTransmit  */ 
...
#define PduRConf_PduRDestPdu_DST_Can_PT_msg_Rear_2_MyECU_0fb271d2_In 0
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define PduRConf_PduRSrcPdu_SRC_Can_PT_msg_Rear_2_MyECU_0fb271d2_In 0
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define PduRConf_PduRSrcPdu_SRC_Can_PT_msg_MyECU_2_Rear_0fb271d2_Out 0
#define PduRConf_PduRSrcPdu_SRC_Can_PT_msg_diag_Response_MyECU_0fb271d2_Out 1
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define PduRConf_PduRDestPdu_DST_Can_PT_msg_MyECU_2_Rear_0fb271d2_Out 0
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define PduRConf_PduRDestPdu_DST_Can_PT_msg_diag_RequestGlobal_0fb271d2_In 0
#define PduRConf_PduRDestPdu_DST_Can_PT_msg_diag_Request_MyECU_0fb271d2_In 1
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define PduRConf_PduRSrcPdu_SRC_Can_PT_msg_diag_RequestGlobal_0fb271d2_In 0
#define PduRConf_PduRSrcPdu_SRC_Can_PT_msg_diag_Request_MyECU_0fb271d2_In 1
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define PduRConf_PduRDestPdu_DST_Can_PT_msg_diag_Response_MyECU_0fb271d2_Out 0
/**\} */
