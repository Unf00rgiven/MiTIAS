...
# define Rte_TypeDef_IdtBatteryStatus
typedef uint16 IdtBatteryStatus;

# define Rte_TypeDef_IdtCharging
typedef boolean IdtCharging;

# define Rte_TypeDef_IdtDioValueType
typedef uint16 IdtDioValueType;

# define Rte_TypeDef_IdtIgnition
typedef boolean IdtIgnition;

# define Rte_TypeDef_IdtLock
typedef boolean IdtLock;

# define Rte_TypeDef_IdtSpeedLimit
typedef uint16 IdtSpeedLimit;

# define Rte_TypeDef_IdtSunlight
typedef uint16 IdtSunlight;
...
extern VAR(IdtBatteryStatus, RTE_VAR_NOINIT) Rte_CpApSEVMIController_PpBatteryStatus_DeBatteryStatus; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
extern VAR(IdtSpeedLimit, RTE_VAR_NOINIT) Rte_CpApSEVMIController_PpSpeedLimit_DeSpeedLimit; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
extern VAR(IdtIgnition, RTE_VAR_NOINIT) Rte_CpSaEngineControl_PpIgnition_DeIgnition; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
extern VAR(IdtLock, RTE_VAR_NOINIT) Rte_CpSaLockControl_PpLock_DeLock; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
extern VAR(IdtCharging, RTE_VAR_NOINIT) Rte_CpSaSolarPanelControl_PpCharging_DeCharging; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
extern VAR(IdtSunlight, RTE_VAR_NOINIT) Rte_CpSaSunlightPresence_PpSunlight_DeSunlight; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
...
extern VAR(IdtLock, RTE_VAR_NOINIT) Rte_Irv_CpApSEVMIController_IrvLockStateOld; /* PRQA S 0850, 3408, 1504 */ /* MD_MSR_19.8, MD_Rte_3408, MD_MSR_8.10 */
...
typedef struct
{
  P2VAR(IdtDioValueType, AUTOMATIC, RTE_CTIOHWAB_APPL_VAR) value; /* PRQA S 0850 */ /* MD_MSR_19.8 */
} Rte_CS_ServerQueueType_CpIoHwAb_PpSpeed_ReadChannel;

typedef struct
{
  uint8 Rte_Free;
  uint8 Rte_Active;
} Rte_CS_ServerQueueInfoType_CpIoHwAb_PpSpeed_ReadChannel;

#  define RTE_START_SEC_VAR_NOINIT_UNSPECIFIED
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

extern VAR(Rte_CS_ServerQueueType_CpIoHwAb_PpSpeed_ReadChannel, RTE_VAR_NOINIT) Rte_CS_ServerQueue_CpIoHwAb_PpSpeed_ReadChannel; /* PRQA S 0850, 3229 */ /* MD_MSR_19.8, MD_Rte_Qac */
extern VAR(Rte_CS_ServerQueueInfoType_CpIoHwAb_PpSpeed_ReadChannel, RTE_VAR_NOINIT) Rte_CS_ServerQueueInfo_CpIoHwAb_PpSpeed_ReadChannel; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
extern CONST(EventMaskType, RTE_CONST) Rte_ModeEntryEventMask_CtSaBatteryModeManager_PpBatteryMode_BatteryModes[2];
...
} Rte_ModeInfoType_CtSaBatteryModeManager_PpBatteryMode_BatteryModes;
