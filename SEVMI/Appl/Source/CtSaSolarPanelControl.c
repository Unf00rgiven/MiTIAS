 ...
 *
 *   Description:  C-Code implementation template for SW-C <CtSaSolarPanelControl>
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
    boolean isCharging;
    Rte_Read_PpChargingIn_DeCharging(&isCharging);
    Rte_Write_PpCharging_DeCharging(isCharging);
